...
export function calcFullyManaged(
  ...
  const eyewearCost =
    participants * d.fullyManagedEyewearCostPerWorker;

  const onboardingAmortized =
    d.fullyManagedOnboardingFee / ONBOARDING_AMORTIZATION_YEARS;
...
export function calcBreakeven(
  ...
  const variableSavingsPerWorker =
    ...
    - (
      d.fullyManagedParticipationRate * d.fullyManagedEyewearCostPerWorker
