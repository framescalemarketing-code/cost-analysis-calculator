  ...
  return (
    <main className="page">
      ...
      <section className="card part-card">
        ...
        <p className="section-sub">
          A Fully Managed Program carries higher fixed overhead but lower per-worker
          variable costs. This chart shows where the lines cross.
        </p>
      ...
      <section className="card part-card">
        ...
        <div className="result-grid two-col" style={{ marginTop: 12 }}>
          <div className="result-card safe">
            <h3>Annual Savings vs. No Program</h3>
            <p className="big-num positive">{currency(npComparison.netSavingsVsNoProgram)}</p>
            <small>reduced annual exposure with a Fully Managed Program</small>
          </div>
          <div className="result-card safe">
